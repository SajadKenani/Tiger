      ...
      <div >
          ...
          <div className="upperShadow"></div>
            <section className=" hidden lg:flex block justify-center p-10 ml-10"   style={{zIndex: "24343213", position: "relative"}}>
                ...
                <div className={window.scrollY > 0 ? " flex justify-between gap-14 navBar pl-12": " flex justify-between gap-14 nav"}>
                ...
                <div>
                <p className="pointer text-white mt-4 nav-text"  onClick={handleMain} onMouseEnter={captureMain} onMouseLeave={leaveMain}> Home </p>
                <div ref={navMainRef} className="p"></div>
                </div>


                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleOurStory} onMouseEnter={captureOurStory} onMouseLeave={leaveOurStory}> OurStory </p>
                <div ref={navStoryRef} className="p"></div>
                </div>

                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleProduct} onMouseEnter={captureProducts} onMouseLeave={leaveProducts}> Products </p>
                ...
                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleWhiteTiger} onMouseEnter={captureWhiteTiger} onMouseLeave={leaveWhiteTiger}> White Tiger</p>
                <div ref={navWhiteTigerRef} className="p"></div>
                </div>

                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleGallery} onMouseEnter={captureGallery} onMouseLeave={leaveGallery}> Gallery </p>
                <div ref={navGalleryRef} className="p"></div>
                </div>

                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleContactUs} onMouseEnter={captureContactUs} onMouseLeave={leaveContactUs}> Contact Us </p>
                ...
                <>
                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleContactUs} onMouseEnter={captureContactUs} onMouseLeave={leaveContactUs}> الاتصال بنا </p>
                <div ref={navContactUsRef} className="p"></div>
                </div>

                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleOurStory} onMouseEnter={captureOurStory} onMouseLeave={leaveOurStory}> قصتنا </p>
                <div ref={navStoryRef} className="p"></div>
                </div>

                <div>
                <p className="pointer text-white mt-4 nav-text" onClick={handleGallery} onMouseEnter={captureGallery} onMouseLeave={leaveGallery}> معرض الصور </p>
                <div ref={navGalleryRef} className="p"></div>
                </div>
